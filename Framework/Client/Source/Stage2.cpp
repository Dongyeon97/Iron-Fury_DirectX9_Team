...
void CStage2::BeginPlay()
{
	...
	m_wpLoverboyActor.lock()->SetSavedBulletHolding(tNonDestroyData.prLoverboy.first);
	m_wpLoverboyActor.lock()->SetSavedBulletLoaded(tNonDestroyData.prLoverboy.second);

	m_wpDisperserActor.lock()->SetSavedBulletHolding(tNonDestroyData.prDisperser.second);
	m_wpDisperserActor.lock()->SetSavedBulletLoaded(tNonDestroyData.prDisperser.second);

	m_wpPenetratorActor.lock()->SetSavedBulletHolding(tNonDestroyData.prPenetrator.second);
	m_wpPenetratorActor.lock()->SetSavedBulletLoaded(tNonDestroyData.prPenetrator.second);

	m_wpChainGunActor.lock()->SetSavedBulletHolding(tNonDestroyData.prChainGun.second);
	m_wpChainGunActor.lock()->SetSavedBulletLoaded(tNonDestroyData.prChainGun.second);
